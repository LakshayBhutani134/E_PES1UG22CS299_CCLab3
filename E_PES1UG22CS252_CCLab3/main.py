...
@app.route('/cart/delete', methods=['POST']) # Changed from GET to POST since it is a destructive operation. This follows RESTful conventions
...
def browse():
    ...
    return render_template('browse.jinja', items=product_list,srn=SRN)
